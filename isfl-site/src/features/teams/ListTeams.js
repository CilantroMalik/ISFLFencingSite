...
export const ListTeams = () => {
    ...
    const teamsForSquad = (squad) => {
        ...
        return squadTeams.sort((team1, team2) => {
            if (Math.round(100 * team1.wins / (team1.wins + team1.losses)) > Math.round(100 * team2.wins / (team2.wins + team2.losses))) { return -1 }
                ...
                if ((team1.boutsWon - team1.boutsLost) > (team2.boutsWon - team2.boutsLost)) { return -1 }
                    ...
                    if ((team1.touchesWon - team1.touchesLost) > (team2.touchesWon - team2.touchesLost)) { return -1 }
                    else if ((team1.touchesWon - team1.touchesLost) > (team2.touchesWon - team2.touchesLost)) { return 1 }
                    else { return 0 }
                }
            }
        })
    ...
    return (
        <div style={{display: "flex", flexDirection: "column", alignItems: "center", backgroundColor: c[theme].mainBG}}>
            ...
            <><h5 className={theme}>Select a gender and weapon above to view teams.</h5></>
            }
            {(weapon !== "None" && gender !== "None") &&
            <>
                ...
                <table style={{width: "70%", color: c[theme].text}}><tbody>
                    <tr style={{fontSize: "1.4rem"}}>
                        ...
                        <th style={{textAlign: "center", borderColor: c[theme].text}}>Meet Win %</th>
                        ...
                        <th style={{textAlign: "center", borderColor: c[theme].text}}>Bout Win Indicator</th>
